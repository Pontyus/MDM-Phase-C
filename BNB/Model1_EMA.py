...
tweets_df2['Number_of_Tweets'] = tweets_df['Number_of_Tweets'].ewm(span=50).mean()  # rolling average on 3 data points
tweets_df2['Average_Number_of_Likes'] = tweets_df['Average_Number_of_Likes'].ewm(span=50).mean()
tweets_df2['Average_Number_of_Retweets'] = tweets_df['Average_Number_of_Retweets'].ewm(span=50).mean()
tweets_df2['Average_Number_of_Replies'] = tweets_df['Average_Number_of_Replies'].ewm(span=50).mean()
tweets_df2['Average_Number_of_Quotes'] = tweets_df['Average_Number_of_Quotes'].ewm(span=50).mean()
tweets_df2['Number_of_Reddit_posts'] = tweets_df['Number_of_Reddit_posts'].ewm(span=50).mean()
